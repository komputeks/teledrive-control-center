...
import { Cloud, Menu, Sparkles } from 'lucide-react';
    ...
    <header className="sticky top-0 z-40 border-b border-slate-200/60 bg-white/80 backdrop-blur-xl dark:border-white/10 dark:bg-slate-950/70">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href={'/app' as Route} className="inline-flex items-center gap-2 rounded-2xl bg-slate-950 px-4 py-2 text-sm font-semibold text-white dark:bg-sky-400 dark:text-slate-950"><Sparkles className="h-4 w-4" /> Start free</Link>
